-- Complete fix for ansh assignment to karan962575@gmail.com
-- This ensures the correct student is assigned and visible in faculty dashboard
...
-- 2. Show all students to find ansh
...
-- 5. Ensure all tables exist and have proper structure
...
-- 8. Create or update faculty record for karan962575@gmail.com
...
-- 9. Create ansh student if it doesn't exist
...
-- 10. Clear all existing assignments
DELETE FROM public.student_mentor_assignments;

-- 11. Create the specific assignment: ansh -> karan962575@gmail.com
...
-- 14. Test the exact query the faculty dashboard uses
SELECT 
