...
-- This migration fixes the community tables structure to match the notification triggers
...
-- Drop the notification system if it exists
...
-- Create community posts table with correct structure
