...
const MyActivitiesPage: React.FC = () => {
  ...
  const [showAddActivityDialog, setShowAddActivityDialog] =
  ...
  const [showNotificationsDropdown, setShowNotificationsDropdown] =
    React.useState(false);
  const [showPlatformConnectDialog, setShowPlatformConnectDialog] =
    React.useState(false);
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  ...
  const [blockchainAchievements, setBlockchainAchievements] = React.useState<
    any[]
  >([]);
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const [showActivityDetailDialog, setShowActivityDetailDialog] =
    React.useState(false);
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  ...
  const [selectedDateActivities, setSelectedDateActivities] = React.useState<
    ActivityItem[]
  >([]);
  ...
  const technicalActivities = activities.filter(
  ...
  const handleDayClick = (dateStr: string) => {
    ...
    setShowActivityDetailDialog(true); // reuse your existing detail dialog
  };
  ...
  return (
    ...
    >
      <div className='pt-4 px-4 py-2'>
        ...
        <div className='mb-8'>
          <div
            className={`rounded-2xl p-8 ${isDarkMode ? 'bg-gradient-to-br from-gray-800 to-gray-900' : 'bg-gradient-to-br from-blue-50 to-purple-50'} border ${isDarkMode ? 'border-gray-700' : 'border-blue-200'}`}
          >
            <div className='flex items-center justify-between mb-6'>
              <div>
                <h2
              ...
              <div className='flex space-x-6'>
                ...
                <div className='text-center'>
                  <div
                    className={`text-4xl font-bold ${isDarkMode ? 'text-orange-400' : 'text-orange-600'}`}
                  >
                    {technicalActivities}
                  </div>
                  <div
                ...
                <div className='text-center'>
                  <div
                    className={`text-4xl font-bold ${isDarkMode ? 'text-purple-400' : 'text-purple-600'}`}
                  >
                    {recentActivities}
                  </div>
                  <div
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
              ...
              >
                <h3
                  className={`text-lg font-semibold mb-4 ${isDarkMode ? 'text-white' : 'text-slate-800'}`}
                >
                  Activity Distribution
                </h3>
                <div className='space-y-3'>
                  {Object.entries(platforms).map(([category]) => {
                    const categoryCount = activities.filter(
                      a => a.category === category
                    ).length;
                    const percentage =
                      totalActivities > 0
                        ? (categoryCount / totalActivities) * 100
                        : 0;
                    const color =
                      category === 'technical'
                        ? 'bg-orange-500'
                    ...
                    return (
                      <div key={category} className='space-y-1'>
                        <div className='flex justify-between items-center'>
                          <span
                            className={`text-sm font-medium capitalize ${isDarkMode ? 'text-gray-300' : 'text-slate-700'}`}
                          >
                            {category}
                          </span>
                          <span
                    ...
                    <div className='flex items-center justify-between mt-4 text-xs'>
                      ...
                      <div className='flex items-center space-x-1'>
                        ...
                        <div className='flex space-x-1'>
                          <div
                            className={`w-3 h-3 rounded-sm ${isDarkMode ? 'bg-gray-800' : 'bg-gray-100'}`}
                          ></div>
            ...
            <div className='mt-6 flex flex-wrap items-center gap-4'>
              <div
                className={`flex items-center space-x-2 px-4 py-2 rounded-full ${isDarkMode ? 'bg-gray-700' : 'bg-white'}`}
              >
              ...
              >
                ...
                >
                  {Math.floor(
                    (verifiedActivities / Math.max(totalActivities, 1)) * 100
                  )}
                  % verified
                </span>
              </div>
        ...
        <div className='mb-8'>
          <div
            className={`rounded-2xl p-6 ${isDarkMode ? 'bg-gradient-to-r from-purple-900 to-pink-900' : 'bg-gradient-to-r from-purple-500 to-pink-500'} text-white`}
          >
            <div className='flex items-center justify-between mb-6'>
              <div>
                ...
                <p className='text-purple-100'>
                  Turn your activities into permanent, verifiable NFTs on the
                  blockchain
                </p>
              </div>
              <div className='flex space-x-3'>
            ...
            {isConnected && walletInfo ? (
              ...
              <div className='bg-white/20 rounded-lg p-6 text-center'>
                ...
                <p className='text-purple-100 mb-4'>
                  Connect your MetaMask wallet to start minting your
        ...
        <div className='flex flex-col sm:flex-row gap-4 mb-4'>
          ...
          <Select value={filterPlatform} onValueChange={setFilterPlatform}>
            <SelectTrigger
              className={`w-full sm:w-48 ${isDarkMode ? 'bg-gray-800 border-gray-600 text-white' : 'bg-white'}`}
            >
        ...
        <div className='space-y-8'>
          ...
          <div
            className={`rounded-2xl p-6 ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} border`}
          >
            <div className='flex items-center justify-between mb-6'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
              {activities
                ...
                .slice(0, 3)
                .map(activity => {
                  const platformConfig = Object.values(platforms)
                    .flat()
                    .find(p => p.name === activity.platform);
                  ...
                  return (
                    ...
                    >
                      <div className='flex items-start space-x-3'>
                        <div
                          className={`p-2 rounded-lg ${isDarkMode ? 'bg-gray-600' : 'bg-white'}`}
                        >
                          <IconComponent className='h-5 w-5 text-orange-600' />
                        </div>
                        <div className='flex-1 min-w-0'>
                          <h4
                            className={`font-semibold ${isDarkMode ? 'text-white' : 'text-slate-800'} truncate`}
                          >
                            {activity.title}
                          </h4>
                          <p
                            className={`text-xs ${isDarkMode ? 'text-gray-400' : 'text-slate-600'} mt-1 line-clamp-2`}
                          >
                            ...
                            <div className='flex space-x-1'>
                              {isConnected && (
                                <Button
                                  ...
                                  variant='ghost'
                                  onClick={() =>
                                    handleMintAchievement(activity)
                                  }
          ...
          >
            <div className='flex items-center justify-between mb-6'>
              ...
              <div className='flex items-center space-x-4'>
                ...
                >
                  {
                    activities.filter(a => a.category === 'extracurricular')
                      .length
                  }
                </span>
                <Button
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
              {activities
                .filter(a => a.category === 'extracurricular')
                .slice(0, 3)
                .map(activity => {
                  const platformConfig = Object.values(platforms)
                    .flat()
                    ...
                    >
                      <div className='flex items-start space-x-3'>
                        ...
                        <div className='flex-1 min-w-0'>
                          ...
                          <div className='flex items-center justify-between mt-3'>
                            <span
                              className={`text-xs px-2 py-1 rounded-full bg-pink-100 text-pink-700`}
                            >
                              {activity.platform}
                            </span>
                            <div className='flex space-x-1'>
        ...
        <Dialog
          open={showPlatformConnectDialog}
          onOpenChange={setShowPlatformConnectDialog}
        >
          <DialogContent
            className={isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white'}
          >
            ...
            <div className='space-y-4 py-4'>
              <div className='space-y-2'>
                <Label className={isDarkMode ? 'text-white' : 'text-slate-700'}>
                  {selectedPlatform === 'Research' ||
                  selectedPlatform === 'Publications'
                    ? 'Author Name'
                    : selectedPlatform === 'Sports'
                      ? 'Player Name'
                      : selectedPlatform === 'Art' ||
                          selectedPlatform === 'Photography'
                        ? 'Artist Name'
              ...
              >
                ...
                <ul
                  className={`text-sm space-y-1 ${isDarkMode ? 'text-gray-300' : 'text-slate-600'}`}
                >
          ...
          <DialogContent className='max-w-4xl max-h-[90vh] overflow-y-auto'>
            ...
            <div className='space-y-4'>
              {blockchainAchievements.length > 0 ? (
                blockchainAchievements.map(achievement => (
                  <div
                    key={achievement.id}
                  ...
                  >
                    <div className='flex items-start justify-between'>
                      <div className='flex-1'>
                        ...
                        <p
                          className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-slate-600'} mt-1`}
                        >
                      ...
                      <div className='flex space-x-2'>
                        <Button
                          ...
                          variant='outline'
                          onClick={() =>
                            handleVerifyAchievement(achievement.nftTokenId)
                          }
